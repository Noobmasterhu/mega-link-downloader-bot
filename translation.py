...
Just send your mega link and I will send the file/video to you!😇
...
✨ <b>I am open source so you can make your own bot from here!👇</b>"""
    ...
    DOWNLOAD_START = "𝗗𝗼𝘄m𝗹𝗼𝗮𝗱𝗶m𝗴 𝘁𝗼 𝗠𝘆 𝗦𝗲𝗿𝘃𝗲𝗿, pleamse wait..📥"
    UPLOAD_START = "𝗨𝗽𝗹𝗼𝗮𝗱𝗶𝗻𝗴 𝗧𝗼 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗡𝗼𝘄, soomn 📤"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS =  "Dowmloaded in <b>{}</b> seconds.\n\nUploaded in <b>{}</b> seconds.\n\n<b>Thanks For Using This Free Service</b>"
